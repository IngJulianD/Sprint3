...
const ComponenteAgregarClientes = () => {
    ...
    const GuardarClientes = async (g) =>{
        g.preventDefault()
        await axios.post(URL,{nombres:nombres, apellidos:apellidos,documento:documento, correo:correo, telefono:telefono, direccion:direccion,ciudad:ciudad})
        Navigate('/clientes');
    }
...
export default ComponenteAgregarClientes;
