...
const ComponenteAgregarProveedore = () => {
    ...
    const GuardarProveedores = async (g) =>{
        g.preventDefault()
        await axios.post(URL,{nombres:nombres, apellidos:apellidos,documento:documento, correo:correo, telefono:telefono, direccion:direccion,empresa:empresa})
...
export default ComponenteAgregarProveedore;
